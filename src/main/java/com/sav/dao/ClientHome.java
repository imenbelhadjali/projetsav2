...
public class ClientHome {
	...
	public Client findById(java.lang.Integer id) {
		...
		try {
			Client instance = (Client) sessionFactory.getCurrentSession()
					.get("com.stage.pfe.dao.Client", id);
			if (instance == null) {
	...
	public List<Client> findAllWithFilter(String attribut,
		...
		if (attribut.equals("Nom"))
			crit = crit.add(Restrictions.like("nomclt",
					valeurRecherche, MatchMode.ANYWHERE));
		
		if (attribut.equals("Prenom"))
			crit = crit.add(Restrictions.like("prenomclt",
					valeurRecherche, MatchMode.ANYWHERE));
		...
		if (attribut.equals("Client"))
			crit = crit.add(Restrictions.or(Restrictions.like("nomclt",
					...
					"prenomclt", valeurRecherche, MatchMode.ANYWHERE)));
